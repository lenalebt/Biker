...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Do. Mrz 24 13:35:08 2011
# Project:  Biker.pro
# Template: app
...
LIBS          = $(SUBLIBS)  -L/usr/lib64/qt4 -L/usr/lib -lcurl -lzzip -lQtXml -L/usr/lib64 -L/usr/lib64/qt4 -lQtGui -L/usr/X11R6/lib -lQtCore -lgthread-2.0 -lrt -lglib-2.0 -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
