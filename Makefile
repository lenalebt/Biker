...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Do. Mär 24 14:26:46 2011
# Project:  Biker.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/share/qt4/mkspecs/linux-g++ CONFIG+=debug -o Makefile Biker.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtXml -I/usr/include/qt4 -I/usr/include -I.
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  -L/usr/lib -L/usr/lib -lcurl -lzzip -lQtXml -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
Makefile: Biker.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ CONFIG+=debug -o Makefile Biker.pro
...
main.o: src/main.cpp src/Database/Parser/osmparser.hpp \
		src/DataPrimitives/DataPrimitives.hpp \
		src/DataPrimitives/osmproperty.hpp \
		src/DataPrimitives/DataPrimitiveDefines.hpp \
		src/DataPrimitives/gpsposition.hpp \
...
srtm.o: src/Database/srtm/srtm.cpp src/Database/srtm/srtm.h \
		src/Database/srtm/zip.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o srtm.o src/Database/srtm/srtm.cpp

zip.o: src/Database/srtm/zip.cpp src/Database/srtm/zip.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o zip.o src/Database/srtm/zip.cpp

osmparser.o: src/Database/Parser/osmparser.cpp src/Database/Parser/osmparser.hpp \
		src/DataPrimitives/DataPrimitives.hpp \
		src/DataPrimitives/osmproperty.hpp \
		src/DataPrimitives/DataPrimitiveDefines.hpp \
		src/DataPrimitives/gpsposition.hpp \
		...
		src/DataPrimitives/osmrelation.hpp \
		src/Database/osmdatabasewriter.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o osmparser.o src/Database/Parser/osmparser.cpp

osmdatabasewriter.o: src/Database/osmdatabasewriter.cpp src/Database/osmdatabasewriter.hpp \
		src/DataPrimitives/DataPrimitives.hpp \
		src/DataPrimitives/osmproperty.hpp \
		src/DataPrimitives/DataPrimitiveDefines.hpp \
		src/DataPrimitives/gpsposition.hpp \
		...
		src/DataPrimitives/osmway.hpp \
		src/DataPrimitives/osmrelation.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o osmdatabasewriter.o src/Database/osmdatabasewriter.cpp

osmrelation.o: src/DataPrimitives/osmrelation.cpp src/DataPrimitives/osmrelation.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o osmrelation.o src/DataPrimitives/osmrelation.cpp
